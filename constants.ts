...
export const DEFAULT_MOBILE_NAV_ORDER = ['dashboard', 'chat', 'trade', 'create', 'warehouse', 'manage', 'create-exit', 'manage-exit', 'manage-invoices', 'security', 'meetings', 'purchase', 'knowledge', 'balances', 'products', 'sales', 'tickets', 'users', 'settings'];
