...
:: Handle cordova plugins only if folder exists
echo if (new File('capacitor-cordova-android-plugins').exists()) { >> android\capacitor.settings.gradle
...
echo } >> android\capacitor.settings.gradle
